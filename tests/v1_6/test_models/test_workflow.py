...
from translator_tom.v1_6 import Query
...
query2: dict[str, Any] = {
    "workflow": [
        {
            "id": "fill",
            "parameters": {"allow_list": ["infores:cohd"], "qedge_keys": ["e0"]},
        },
        {
            "id": "overlay_compute_ngd",
        ...
        {"id": "fill", "parameters": {"qedge_keys": ["e1", "e2", "e3", "e4"]}},
        {"id": "bind"},
        {"id": "score"},
    ],
    "message": {
        "query_graph": {
            "edges": {
                ...
                "e1": {
                    "subject": "n1",
                    "object": "n2",
                    "predicates": ["biolink:increases_activity_of"],
                },
                "e2": {
                    "subject": "n3",
                    "object": "n2",
                ...
                "e3": {
                    "subject": "n1",
                    "object": "n2",
                    "predicates": ["biolink:decreases_activity_of"],
            ...
            "nodes": {
                ...
                "n1": {"is_set": "false", "categories": ["biolink:ChemicalEntity"]},
                "n2": {
                    "is_set": "false",
                    "categories": ["biolink:Gene", "biolink:Protein"],
                },
                "n3": {"is_set": "false", "categories": ["biolink:ChemicalEntity"]},
            },
        }
    },
}
...
def test_workflow():
    ...
    assert "runner_parameters" in query_dict["workflow"][0]
    assert "parameters" in query_dict["workflow"][0]
    assert "allowlist" in query_dict["workflow"][0]["runner_parameters"]
    assert "denylist" in query_dict["workflow"][0]["parameters"]
