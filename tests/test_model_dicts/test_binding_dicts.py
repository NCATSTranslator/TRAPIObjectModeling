...
from translator_tom.model_dicts.edge_binding import EdgeBindingDictUtil
from translator_tom.model_dicts.node_binding import NodeBindingDictUtil
from translator_tom.model_dicts.path_binding import PathBindingDictUtil
