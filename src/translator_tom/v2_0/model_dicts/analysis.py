...
from translator_tom.utils.shared import CURIE, AuxGraphID, QEdgeID, QPathID
from translator_tom.v2_0.model_dicts.attribute import AttributeDict, AttributeDictUtil
